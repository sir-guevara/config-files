...
install -d "/usr/share/themes/$theme/gtk-3.0"
install -m 0644 "$repo_dir/lightdm/$theme/gtk-3.0/gtk.css" \
    "/usr/share/themes/$theme/gtk-3.0/gtk.css"
cp -a "$desktop_home/.local/share/icons/$icons" /usr/share/icons/
install -m 0644 "$desktop_home/walls/wall9.jpg" /usr/share/backgrounds/groovy-lightdm.png
